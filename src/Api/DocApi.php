 ...
 * 文档接口
 *
 * 子类继承自本类即可拥有如下两个接口，用于实现接口文档的前后端分离：
 * ```php
 * namespace App\Api;
 * class Document extends \PhalApi\Api\DocApi { }
 * ```
 * 所有接口的相关信息：index.php?service=App.Document.List
 * 某个接口的相关信息：index.php?service=App.Document.Desc&api=App.Site.Index
 *
